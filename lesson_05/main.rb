  ...
  case answer
    when "1"
      ...
      loop do
        name = gets.chomp
        break if name == ""
        if stations.select { |station| station.name == name } != []
    ...
    when "2"
      ...
      loop do
        name = gets.chomp
        break if name == ""
        if trains.select { |train| train.name == name } != []
    ...
    when "3"
      ...
      loop do
        name = gets.chomp
        break if name == ""
        station = stations.select { |station| station.name == name } [0]
        if !station
    ...
    when "4"
      ...
      loop do
        name = gets.chomp
        break if name == ""
        train = trains.select { |train| train.name == name } [0]
        break if train
